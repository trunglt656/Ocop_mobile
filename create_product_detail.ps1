    ...
    <>
      ...
      <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.imageSection}>
          <Image
            source={{ uri: product.images[selectedImageIndex]?.url || 'https://via.placeholder.com/400x300' }}
        ...
        <View style={styles.infoSection}>
          ...
          <View style={styles.detailsSection}>
            ...
            <View style={styles.detailRow}>
              <ThemedText style={styles.detailLabel}>Đã bán:</ThemedText>
              <ThemedText style={styles.detailValue}>{product.totalSold}</ThemedText>
            </View>
          </View>

          {/* Producer Info */}
          <View style={styles.producerSection}>
            <ThemedText style={styles.producerTitle}>Thông tin nhà sản xuất</ThemedText>
            <ThemedText style={styles.producerName}>{product.producer.name}</ThemedText>
            <ThemedText style={styles.producerDetail}>📞 {product.producer.phone}</ThemedText>
            <ThemedText style={styles.producerDetail}>📧 {product.producer.email}</ThemedText>
            <ThemedText style={styles.producerDetail}>📍 {product.origin.address}</ThemedText>
          </View>
        </View>
      </ScrollView>
...
Set-Content -Path "d:\DATN\demo1\ocop_DN\ocop_frontend\app\product\[id].tsx" -Value $content -Force
